...
python -u -c "from kanlytics.gantt.gantt_service import KanlyticsBackend; KanlyticsBackend.launch(url='http://0.0.0.0:${BACKEND_PORT}/', timeout=15); import time; time.sleep(10**9)" &
BACKEND_PID="$!"
